...
class SupplierController extends Controller
{
    ...
    {
        $supplier = SupplierModel::select('supplier_id', 'supplier_kode', 'supplier_nama', 'supplier_telp', 'supplier_alamat');
    ...
    public function store_ajax(Request $request)
    {
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                ...
                'supplier_nama' => 'required|string|max:100',
                'supplier_telp' => 'required|string|min:8|max:15',
                'supplier_alamat' => 'required|string|min:5|max:200',
            ];
    ...
    public function update_ajax(Request $request, $id)
    {
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                'supplier_kode' => 'required|string|min:3|max:20|unique:m_supplier,supplier_kode,'.$id.',supplier_id',
                'supplier_nama' => 'required|string|max:100',
                'supplier_telp' => 'required|string|min:8|max:15',
                'supplier_alamat' => 'required|string|min:5|max:200',
            ];
